...
public class RollerCoaster {
	...
	if(heightAsInt >= 48) { 
		...
		// Do you see the heightToRide > 48 underlined red? That is because you are comparing a STRING to an INTEGER.
	...
	JOptionPane.showMessageDialog(null, "Nice! You're tall enough to ride alone!");
	}
	...
	JOptionPane.showMessageDialog(null, "You must be at least 42 inches tall to ride the roller coaster... Sorry!");
	}
